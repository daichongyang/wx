...
// var httpUrl = "http://192.168.0.107:8080";
...
// 账单支付
export const platformBills = params => {
  return requestApi("post", '/platformOrderController/platform/bills', params)
}

// 更新线下交易结果
export const updateOfflineTradeResult = params => {
  return requestApi("post", "/merchWallet/updateOfflineTradeResult/" + params.houseId + "/" + params.orderNo)
}

//消息标记为已读--管理端
export const markMessage = messageId => {
  return requestApi("post", '/v1.0/admin/message/mark/' + messageId)
}
//删除消息--管理端
export const deleteMessage = params => {
  return requestApi("post", '/v1.0/admin/message/delete', params)
}

//消息列表--管理端
export const messageList = params => {
  return requestApi("post", '/v1.0/admin/message/list', params)
}

// 未读条数提醒
export const messageUnread = params => {
  return requestApi("post", '/v1.0/admin/message/unread', params)
}
// 房间所属甲方名称(房东) 【/租约/登记】
export const customerName = houseId => { return requestApi('get',"/v1.0/admin/house/customer/name/" + houseId) }

//租约详情 【租约/租约列表/租约详情】
export const leaseDetaill = leaseId => { return requestApi("post", '/v1.0/admin/lease/detail/' + leaseId) }
